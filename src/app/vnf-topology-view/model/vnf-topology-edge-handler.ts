...
const { mxClient, mxGraph, mxGraphModel, mxConstants, mxPerimeter, mxUtils, mxEvent, mxEdgeHandler,
...
export class VnfTopologyEdgeHandler extends mxEdgeHandler {

    domNode: HTMLDivElement;

    state: mxgraph.mxCellState;
